    ...
    >
        ...
        <svg className="w-full h-full" viewBox="0 0 200 200" preserveAspectRatio="xMidYMid slice">
          <pattern id="paisleyPattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
            <path
              ...
              strokeWidth="1"
            />
            <circle cx="50" cy="60" r="8" fill="none" stroke="#8B0000" strokeWidth="0.5" />
          </pattern>
      ...
      <div className="relative max-w-4xl mx-auto px-4">
        ...
        <div className="relative">
          {/* Center Line */}
          <div className="absolute left-[20px] md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#D4AF37] via-[#8B0000] to-[#D4AF37]" />
          ...
          {[
            ...
            >
              ...
              >
                <div className="w-4 h-4 rounded-full bg-[#D4AF37] border-2 border-[#FFF8F0] shadow-lg absolute top-6 md:top-auto md:relative z-10" />
              </div>

              <div className="gold-frame bg-gradient-to-br from-[#8B0000] to-[#6B0000] rounded-xl p-6 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                <h3 className="font-heading text-xl sm:text-2xl text-[#D4AF37] mb-2">
                  {event.title}
                </h3>
